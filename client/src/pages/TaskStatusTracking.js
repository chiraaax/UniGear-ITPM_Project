...
const TaskStatusTracking = () => {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <h1 className="text-3xl font-bold text-slate-50 mb-8">Task Status Tracking</h1>
      ...
      {!loading && (
        <div className="space-y-6">
          ...
          <div className="bg-slate-900 p-6 rounded-lg border border-slate-700">
            <h2 className="text-xl font-semibold text-slate-50 mb-4">Tasks by Category</h2>
              ...
              <div className="space-y-3">
                {Object.entries(taskStats.byCategory).map(([category, count]) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-semibold bg-slate-700 px-3 py-1 rounded-full text-slate-100">
                      {count}
                    </span>
                  </div>
                ))}
          ...
          {/* Status Chart */}
          <div className="bg-slate-900 p-6 rounded-lg border border-slate-700">
            <h2 className="text-xl font-semibold text-slate-50 mb-4">Status Distribution</h2>
